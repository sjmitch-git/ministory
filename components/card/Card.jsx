...
import { formatDate, snakeCase } from '@smitch/js-lib'

import * as ga from '../../lib/ga'

const Card = ({ label, data, genre, date, setFilter, removeFromStorage }) => {
	...
	return (
		<div className='relative mb-8 rounded-lg bg-white p-2 text-left shadow-lg md:p-4'>
			...
			<div className='mb-4 flex justify-between'>
				<button
					className='all-small-caps relative z-10 font-bold text-info'
